    ...
    return (
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                ...
                "Principles are concrete",
                "Framework is usable",
            ),
            fail_criteria=(
                "Vague goals",
                "Principles are platitudes",
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                "Complete journeys for all personas",
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                "All criteria in structured format",
                "Edge cases covered",
                "NFRs measurable",
            ),
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                ...
                "Values non-generic",
                "Voice usable by content team",
            ),
            fail_criteria=(
                "Positioning same as competitor",
                "Values are clichés",
                "Voice too vague to implement",
            ),
        ),
        ArtifactContract(
            ...
            pass_criteria=(
                ...
                "Voice examples for 3+ contexts",
                "Accessibility considered",
            ),
            fail_criteria=(
                "Colors not meeting WCAG AA contrast",
                "No fallback fonts",
                "Voice examples missing",
            ),
        ),
        ArtifactContract(
            ...
            pass_criteria=(
                "All pillars have sample content",
                "Messaging framework covers all personas",
                "Content model is structured",
            ),
            fail_criteria=(
                "Pillars not linked to personas",
                "Messaging inconsistent across channels",
                "No localization plan",
            ),
        ),
        # ---- UX / UI ----
        ArtifactContract(
            ...
            pass_criteria=(
                "Complete flows for all core journeys",
                "Error states designed",
                "Decision logic explicit",
            ),
            fail_criteria=(
                "Missing error states",
                "Flows don't match personas",
                "Decision points ambiguous",
            ),
        ),
        ArtifactContract(
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                "Complete visual designs for all screens",
                "Design system compliance",
                "Responsive breakpoints",
            ),
            fail_criteria=(
                "Screens using non-design-system components",
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                ...
                "Contrast ratio requirements specified",
            ),
            fail_criteria=(
                "WCAG level not specified",
                "Keyboard nav ignored",
                "Screen reader not considered",
            ),
        ),
        # ---- Architecture ----
        ArtifactContract(
        ...
        ArtifactContract(
            ...
            fail_criteria=(
                "Missing endpoints for product features",
                "Schemas incomplete",
        ...
        ArtifactContract(
            ...
            fail_criteria=(
                "Denormalized without justification",
                "Missing indexes",
                "No migration plan",
                "No retention policy",
            ),
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                ...
                "A11y plan actionable",
            ),
            fail_criteria=(
                "Components not mapped to UI screens",
        ...
        ArtifactContract(
            ...
            required_fields=(
                ...
                "responsive_breakpoint_results",
                "cross_browser_results",
                "dark_mode_results",
                "animation_fidelity",
                "design_system_compliance",
                "pixel_comparison_summary",
                "defects",
            ),
            consumers=(
                "ui_designer",
            ...
            pass_criteria=(
                ...
                "Responsive layouts match designs",
                "Dark mode consistent",
                ">= 95% design fidelity",
            ),
            fail_criteria=(
                "Visual regressions detected",
                "Breakpoint layout failures",
                "Dark mode broken",
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                "All gates passing or waived with justification",
                "Open issues non-blocking",
                "Changelog complete",
            ),
            fail_criteria=(
                "Critical gate failing",
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                "Complete funnel with metrics",
                "Acquisition channels prioritized",
                "KPIs measurable",
                "Experiment roadmap",
            ),
            fail_criteria=(
                "Funnel not measurable",
                "No retention model",
                "KPIs vague",
                "No experiment plan",
            ),
        ...
        ArtifactContract(
            ...
            pass_criteria=(
                "No critical ethics violations",
                "Privacy respected",
                "Bias assessed",
                "Accessibility addressed",
            ),
            fail_criteria=(
                "Critical ethics violations unaddressed",
                "Bias confirmed but not remediated",
...
class ContractRegistry:
    ...
    def _build_indexes(self) -> None:
        for contract in self._contracts:
            ...
            self._by_owner[contract.owner_agent] = self._by_owner[
